                    ...
                    <div class="col-md-8">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <p class="card-text">Laravel has wonderful, thorough documentation covering every aspect of the framework.</p>
                                <a href="https://laravel.com/docs" class="btn btn-link">Read the docs</a>
                            </div>
                        </div>
                    </div>
                </div>
